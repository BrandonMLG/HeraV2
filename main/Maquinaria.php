        ...
        <script>
            ...
            function realizaProceso() {
                ...
                $.ajax({
                    ...
                    url: 'AJAX/buscarMaquinas.php', //archivo que recibe la peticion
        ...
        <div id="main-wrapper">
            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-expand-md navbar-light">
                    ...
                    <?php echo $BE->navbarHeader('Maquinaria', 'Administrador'); ?> 
                ...
                <div class="container-fluid">
                    <div class="row page-titles">
                        <div class="col-md-2 text-center">
                            <h3 class="text-themecolor"> <a href="#">Buscador</a></h3>
                        </div>
                        <div class="col-md-3 text-center">
                            <input type="text" class="form-control mt-0"  id="busqueda" name="busqueda" autofocus="on" autocomplete="off" onkeyup= "if (event.keyCode == 13)
                                        realizaProceso()" >
                        </div>

                        <div class="col-md-2 text-center">
                            <select class="form-control custom-select btn-secondary" id="criterio" onchange="realizaProceso()">
                                <option class="text-center" value="Maquina">Tipo Maquina</option>
                                <option class="text-center" value="NumeroActivo">Numero</option>  
                                <option class="text-center" value="Modelo">Modelo</option>
                                <option class="text-center" value="Ubicacion">Ubicacion</option>
                            </select>
                            <small class="form-control-feedback">Criterio de Busqueda</small> 
                        </div>
                        <div class="col-md-2 text-center">
                            <select class="form-control custom-select btn-secondary" id="estado" onchange="realizaProceso()">
                                <option class="text-center" value="">Todos</option>
                                <option class="text-center" value="Verde">Verde</option>
                                <option class="text-center" value="Amarillo">Amarillo</option>
                                <option class="text-center" value="Rojo">Rojo</option>
                                <option class="text-center" value="Negro">Negro</option>
                            </select>
