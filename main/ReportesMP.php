        ...
        <script>
            function realizaProceso() {
                ...
                $.ajax({
                    ...
                    url: 'AJAX/reportesMP.php', //archivo que recibe la peticion
                ...
                for (i = 0; i < checkboxes.length; i++) //recoremos todos los controles
                {
                    if (checkboxes[i].type == "checkbox") //solo si es un checkbox entramos
                    {
                        if (checkboxes[i].getAttribute("checked")) {
                            ...
                            checkboxes[i].setAttribute("checked", ""); //si es un checkbox le damos el valor del checkbox que lo llamó (Marcar/Desmarcar Todos)
        ...
        <div id="main-wrapper">
            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-expand-md navbar-light">
                    ...
                    <?php echo $BE->navbarHeader('Reportes de Mantenimiento Preventivo', 'Administrador'); ?> 
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid p-b-0">
                    <div class="row page-titles">
                        ...
                        <div class="col-md-3 text-center">
                            <input type="text" class="form-control mt-0 text-center font-weight-bold"  id="busqueda" name="busqueda" autofocus="on" autocomplete="off" onkeyup= "if (event.keyCode == 13)
                                        realizaProceso()" >
                        </div>

                        <div class="col-md-3 text-center">
                            <select class="form-control custom-select btn-secondary" id="criterio" onchange="realizaProceso()">
                                <option class="text-center" value="Inspector">Inspector</option>
