        ...
        <script>
            function realizaProceso() {
                ...
                var parametros = {
                    ...
                    "estadoRefaccion": estado
                };
                $.ajax({
                    data: parametros, //datos que se envian a traves de ajax
                    url: 'AJAX/buscarRefacciones.php', //archivo que recibe la peticion
        ...
        <div id="main-wrapper">
            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-expand-md navbar-light">
                    ...
                    <?php echo $BE->navbarHeader('Refacciones', 'Administrador'); ?> 
                    ...
                    <div class="row page-titles">
                        ...
                        <div class="col-md-2 text-center">
                            <select class="form-control custom-select btn-secondary" id="filtro" onchange="realizaProceso()">
                                <option class="text-center" value="estante">Estante</option>
                                <option class="text-center" value="descripcion">Nombre</option>
                                <option class="text-center" value="clave">Clave</option>
                        ...
                        <div class="col-md-2 text-center">
                            <select class="form-control custom-select btn-secondary" id="estado" onchange="realizaProceso()">
                                <option class="text-center" value="0">Activos y Obs. </option>
                                <option class="text-center" value="1">Activos</option>
                                <option class="text-center" value="2">Obsoletos</option>
                            </select>
                            <small class="form-control-feedback">Filtro de Estado.</small>
                        </div>
                        <div class="col-md-3">
                            <ol class="breadcrumb">
